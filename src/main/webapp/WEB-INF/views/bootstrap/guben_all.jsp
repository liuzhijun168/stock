...
<%
	String keywords = request.getParameter("k");
	if (keywords == null) {
		return;
	}
	String sql = "select * from stock_data_query sdq left join stock_guben gb on sdq.b = gb.stockCode left join stock_ticai_detail td on sdq.b = td.code and orderBy=1 where stockholderName like '%"
			+ keywords + "%' or sdq.b ='"+keywords+"' or sdq.c like '%"+keywords+"%'";// and g is not null";
