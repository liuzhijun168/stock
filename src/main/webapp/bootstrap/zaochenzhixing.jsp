...
<%
	List<String> zaochenzhixingList = DataTools.getZaoChenZhiXing();
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						     <%
						      for(int i=0; i<zaochenzhixingList.size() ; i++){
						    	  String stockCode = zaochenzhixingList.get(i);
						    	  String sql = "select * from stock_data_query sdq,stock_data sd where date_format(sd.create_date,'%Y-%m-%d') = '2014-12-26' and sd.b='"+stockCode+"' and sd.c not like '%S%'  and sdq.b=sd.b and n>0 and sdq.o!=0";
