...
<body>
		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li>
					<li><a href="#">板块龙虎版</a></li>
					<i class="icon-angle-right"></i>
					<li><a href="#">领先前${param.num}</a></li>
				</ul>
	...
	<script type="text/javascript">
		swfobject.embedSWF(
		  ...
		  {"data-file":"${pageContext.request.contextPath}/BanKuaiLongHuBanServlet?num=<%=request.getParameter("num")%>","loading":"数据加载中..."}
		  );
		</script>
	<!-- end: JavaScript-->
